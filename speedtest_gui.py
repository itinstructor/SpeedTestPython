...
class SpeedTestGui(ct.CTk):
    ...
    def __init__(self):
        ...
        self.geometry("385x250")
        self.iconbitmap("speedometerlight-32.ico")
    ...
    def create_widgets(self):
        ...
        self.lbl_download_label = ct.CTkLabel(
            self.main_frame, anchor=ct.E, text="Download:", width=14
        )
        self.lbl_upload_label = ct.CTkLabel(
            self.main_frame, anchor=ct.E, text="Upload:", width=14
        )
        self.lbl_ping_label = ct.CTkLabel(
            self.main_frame, anchor=ct.E, text="Ping (Latency):", width=14
        )

        self.lbl_download = ct.CTkLabel(self.main_frame, width=17, text="")
        self.lbl_upload = ct.CTkLabel(self.main_frame, width=17, text="")
        self.lbl_ping = ct.CTkLabel(self.main_frame, width=17, text="")
